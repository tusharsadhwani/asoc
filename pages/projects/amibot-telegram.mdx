...
<Chip level={'Easy'} url={"https://github.com/asetalias/amibot-tg/issues/20"} />
...
<Chip level={'Easy'} url={"https://github.com/asetalias/amibot-tg/issues/26"} />
...
<Chip level={'Hard'} url={"https://github.com/asetalias/amibot-tg/issues/29"} />

**Description**

Refer to [issue](https://github.com/asetalias/amibot-tg/issues/29)

---

### Show Exam Room No if its available

<Chip level={'Easy'} url={"https://github.com/asetalias/amibot-tg/issues/33"} />
...
<Chip level={'Medium'} url={"https://github.com/asetalias/amibot-tg/issues/56"} />
...
<Chip level={'Hard'} url={"https://github.com/asetalias/amibot-tg/issues/57"} />
...
<Chip level={'Hard'} url={"https://github.com/asetalias/amibot-tg/issues/61"} />
