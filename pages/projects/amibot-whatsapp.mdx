...
<Chip level={'Easy'} url={"https://github.com/asetalias/amibot/issues/47"} />
...
<Chip level={'Hard'} url={"https://github.com/asetalias/amibot/issues/46"} />
...
<Chip level={'Medium'} url={"https://github.com/asetalias/amibot/issues/41"} />
