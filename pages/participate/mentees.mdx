...
2. **Prepare Your Proposal**: Craft a compelling application that highlights your motivation, relevant skills, and preferred projects. Be sure to showcase your passion for open-source software development and your commitment to contributing to the community.
   Refer to this document for a template on how to write the project proposal : https://docs.google.com/document/d/1h7WcT56eHi_pNDFqDO8HDMe0bh31cjP1kjnLnh_VioM/edit?usp=sharing
3. **Submit Your Proposal**: Once your application is ready, submit it through the [Mentee form](#mentee-form). Double-check that you have included all the necessary details and have expressed your enthusiasm for the program.
